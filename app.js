...
const hoursMap = [
  { val: 5, time00: '05:00', time30: '05:30' },
  { val: 6, time00: '06:00', time30: '06:30' },
  ...
  { val: 1, time00: '13:00', time30: '13:30' },
  { val: 2, time00: '14:00', time30: '14:30' },
  { val: 3, time00: '15:00', time30: '15:30' },
  { val: 4, time00: '16:00', time30: '16:30' },
  { val: 5, time00: '17:00', time30: '17:30' },
  { val: 6, time00: '18:00', time30: '18:30' },
  { val: 7, time00: '19:00', time30: '19:30' },
  { val: 8, time00: '20:00', time30: '20:30' },
  { val: 9, time00: '21:00', time30: '21:30' },
  { val: 10, time00: '22:00', time30: '22:30' },
  { val: 11, time00: '23:00', time30: '23:30' }
];
...
function checkOverlapsAndConfirm(startSlot, duration, ignoreSlot = null) {
  ...
  for (let i = 0; i < duration; i++) {
    ...
    if (idx >= timeSlotsOrder.length) {
      alert('La tarea se extiende más allá del horario disponible (23:30).');
      return false;
    }
